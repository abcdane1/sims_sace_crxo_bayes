#data simulation for CRXO, lognormal mixture
...
crxodfsimlogit_v2_mix<-function(I,J,csl,csu,mux,zp,wp,
  ...
  for(j in 1:J){
    for(i in 1:I){
      ...
      y1val11_2<-MASS::mvrnorm(n=1,mu=meany1val11_2,Sigma=Sigmay11) #random draw 111
      y1val10_2<-MASS::mvrnorm(n=1,mu=meany1val10_2,Sigma=Sigmay10) #random draw 101
      y0val11_2<-MASS::mvrnorm(n=1,mu=meany0val11_2,Sigma=Sigmay11) #random draw 110

#data simulation for CRXO, lognormal mixture, scaled variance 
...
#params y g=11, trt = 1: mixture of y111_1 and y111_2 (trt,int,x,j), 
#params y g=11, trt = 0 : mixture of y110_1 and y110_2 (int,x,j)
  #error var sigma2y11 (changed for y110_2)
#params y g=10, trt = 1 : mixture of y101_1 and y101_2 (int,x,j)
#error var sigma2y10 (changed for y101_2)
...
#mix_par: mixture parameter for 1 and 2 (same for all)
#sec - include period
#trtp - treatment sequence probability of assign
#logscale - T= outcome y is logged

crxodfsimlogit_v2_mix<-function(I,J,csl,csu,mux,zp,wp,
                                y111_1,y110_1,y101_1,
                                y111_2,y110_2,y101_2,
                                sigma2y11,sigma2y10, 
                                sdscz,sdscpz,sdscw,sdscpw,
                                sdyc11,sdycp11,sdyc10,sdycp10,mix_par,sec=T,
                                trtp=.5,logscale=T){
  ...
  for(j in 1:J){
    for(i in 1:I){
      ...
      var_shift11<-.25*sigma2y11 #shifted error variance
      var_shift10<-.25*sigma2y10 #shifted error variance 
      ...
      #linear combos
      #outcome y111_1
      meany1val11_1<-y111_1[1]+y111_1[2]+y111_1[3]*valx1+y111_1[4]*valx2+y111_1[5]*valx3+y111_1[6]*(j-1)+Txiii11+Tgammaiji11 #mean
      #outcome y101_1
      meany1val10_1<-y101_1[1]+y101_1[2]*valx1+y101_1[3]*valx2+y101_1[4]*valx3+y101_1[5]*(j-1)+Txiii10+Tgammaiji10 #mean
      #outcome y110_1
      meany0val11_1<-y110_1[1]+y110_1[2]*valx1+y110_1[3]*valx2+y110_1[4]*valx3+y110_1[5]*(j-1)+Txiii11+Tgammaiji11 #mean
      
      #outcome y111_2
      meany1val11_2<-y111_2[1]+y111_2[2]+y111_2[3]*valx1+y111_2[4]*valx2+y111_2[5]*valx3+y111_2[6]*(j-1)+Txiii11+Tgammaiji11 #mean
      #outcome y101_2
      meany1val10_2<-y101_2[1]+y101_2[2]*valx1+y101_2[3]*valx2+y101_2[4]*valx3+y101_2[5]*(j-1)+Txiii10+Tgammaiji10 #mean
      #outcome y110_2
      meany0val11_2<-y110_2[1]+y110_2[2]*valx1+y110_2[3]*valx2+y110_2[4]*valx3+y110_2[5]*(j-1)+Txiii11+Tgammaiji11 #mean
      
      #drawing outcomes 
      y1val11_1<-MASS::mvrnorm(n=1,mu=meany1val11_1,Sigma=Sigmay11) #random draw 111
      y1val10_1<-MASS::mvrnorm(n=1,mu=meany1val10_1,Sigma=Sigmay10) #random draw 101
      y0val11_1<-MASS::mvrnorm(n=1,mu=meany0val11_1,Sigma=Sigmay11) #random draw 110
      
      y1val11_2<-MASS::mvrnorm(n=1,mu=meany1val11_2,Sigma=Sigmay11+var_shift11*diag(cij)) #random draw 111
      y1val10_2<-MASS::mvrnorm(n=1,mu=meany1val10_2,Sigma=Sigmay10+var_shift10*diag(cij)) #random draw 101
      y0val11_2<-MASS::mvrnorm(n=1,mu=meany0val11_2,Sigma=Sigmay11+var_shift11*diag(cij)) #random draw 110
      
      #component of mixture model each person would be in for this cluster
      mix_bin<-rbinom(n=cij,size=1,prob=mix_par)
      
      #values depending on that mixture 
      y1val11<-ifelse(mix_bin==1,y1val11_1,y1val11_2)
      y1val10<-ifelse(mix_bin==1,y1val10_1,y1val10_2)
      y0val11<-ifelse(mix_bin==1,y0val11_1,y0val11_2)
